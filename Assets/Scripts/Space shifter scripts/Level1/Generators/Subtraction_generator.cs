...
public class Subtraction_generator : MonoBehaviour {
    ...
    void generator()
    {
        ...
        while (true)
        {
            ...
            if (left_multiplier[0] - right_multiplier[0] >= down_limit )
            {
                break;
            }
        }
    ...
    public string[] Get_multipliers_Subtraction()
    {
        generator();
        return all_multipliers;
    }
    public void set_SUB_params(int theHighestNumber,int downLimit)
    {
